...
Note that some functions have been removed/replaced, default parameters changed, and data structure different, in Seurat v5 vs Seurat v4. Version difference may lead to some scrips breaking and may lead to slight graphical differences (e.g., volcanoplot because of change in FC in FindMarkers), but do not otherwise affect the results (e.g., list of differentially expressed genes).
