...
Please see STAR Methods in Wei et al 2023 manuscript for software and package versions. E.g., in Seurat v5 some functions have been removed/replaced, and default parameters changed, vs Seurat v4.
